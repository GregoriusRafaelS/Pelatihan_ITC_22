        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children:[
                Row(children: [Icon(Icons.person), SizedBox(width: 10,), SizedBox(width: 75, child: Text("ID"),), Text(": ${widget.id}"),]),
                Row(children: [Icon(Icons.first_page), SizedBox(width: 10,), SizedBox(width: 75, child: Text("First Name"),), Text(": ${widget.firstName}"),]),
                Row(children: [Icon(Icons.last_page), SizedBox(width: 10,), SizedBox(width: 75, child: Text("Last Name"),), Text(": ${widget.lastName}"),]),
                Row(children: [Icon(Icons.email), SizedBox(width: 10,), SizedBox(width: 75, child: Text("Email"),), Text(": ${widget.email}"),]),
              ]
          ),)
        ],
      ),
